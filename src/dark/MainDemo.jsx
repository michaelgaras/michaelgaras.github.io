    ...
    render() {
        ...
        return (
            <div className="active-dark">
                ...
                {/* Start Slider Area   */}
                <div style={{ height: this.state.height }} className="slider-activation slider-creative-agency with-particles" id="home">
                    ...
                    <div style={{ height: this.state.height}}className="bg_image bg_image--27">
